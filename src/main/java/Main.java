...
public class Main {
    public static void main(String[] args) {
        ...
        final RegistrationOrderRequest registrationOrderRequest = new RegistrationOrderRequest("555", BigDecimal.valueOf(10), "some desc", shopId, pwd, "https://some.url.to/redirect/after/payment", "RU");
